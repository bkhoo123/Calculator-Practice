//TODO # 1 Change Background on CSS 
...
class Calculator {
    ...
    updateDisplay() {
        this.currentNumbers.innerText = this.getDisplayNumber(this.currentOperand)
        if (this.operation != null) {
            this.previousNumbers.innerText = `${this.previousOperand} ${this.operation}`
        } else {
            this.previousNumbers.innerText = ''
        }
    }
}
